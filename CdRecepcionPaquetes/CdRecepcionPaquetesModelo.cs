// Archivo: CdRecepcionPaquetes/CdRecepcionPaquetesModelo.cs
using System;
...
{
    public class CdRecepcionPaquetesModelo
    {
        // -------- Datos de prueba ----------
        private readonly List<ClienteEnt> _clientes = new List<ClienteEnt>
        {
            new ClienteEnt { Cuit = "20123456780", RazonSocial = "Transporte TUTASA S.A.", CondicionIVA = CondicionIVAEnum.ResponsableInscripto, ConvenioVigente = true },
            new ClienteEnt { Cuit = "27234567892", RazonSocial = "Logística Andina SRL",   CondicionIVA = CondicionIVAEnum.Monotributo, ConvenioVigente = true },
            new ClienteEnt { Cuit = "20345678900", RazonSocial = "Distribuidora Central S.A.", CondicionIVA = CondicionIVAEnum.ResponsableInscripto },
            new ClienteEnt { Cuit = "23321098761", RazonSocial = "Envíos Express SRL",    CondicionIVA = CondicionIVAEnum.NoResponsable },
            new ClienteEnt { Cuit = "30765432108", RazonSocial = "Comercial del Plata S.A.", CondicionIVA = CondicionIVAEnum.Exento }
        };
        ...
        {
            // Usa los nombres del enum tal cual
